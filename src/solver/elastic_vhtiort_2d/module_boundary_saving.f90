...
module elastic_vhtiort_2d_boundary_saving
...
contains
    ...
    subroutine output_final_step_wavefield
        ...
        write (funit) vx, vz, stressxx, stresszz, stressxz
    ...
    subroutine input_final_step_wavefield
        ...
        read (funit) vx, vz, stressxx, stresszz, stressxz
    ...
    subroutine save_boundary_wavefield(t)
        ...
        vx(xbwend1:xbwend2, xbwbegz:xbwendz), &
            ! top boundary
        vx(zbwbegx:zbwendx, zbwbeg1:zbwbeg2), &
            ! bottom boundary
        vx(zbwbegx:zbwendx, zbwend1:zbwend2), &
            ! left boundary
        vz(xbwbeg1:xbwbeg2, xbwbegz:xbwendz), &
            ! right boundary
        vz(xbwend1:xbwend2, xbwbegz:xbwendz), &
            ! top boundary
