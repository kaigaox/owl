...
module elastic_vhtiort_3d_cfspml
                ...
                case ('x')
                    ...
                    do jj = 1, m2
                        do ii = 1, m1
                            ...
                            j = (jj - 1)*interval + n2a
                            r(ii, jj) = damp_ratio( &
                                c11(bindex, i, j), c12(bindex, i, j), c13(bindex, i, j), 0.0, 0.0, 0.0, &
                                c22(bindex, i, j), c23(bindex, i, j), 0.0, 0.0, 0.0, &
                                c33(bindex, i, j), 0.0, 0.0, 0.0, &
                                c44(bindex, i, j), 0.0, 0.0, &
                                c55(bindex, i, j), 0.0, &
                                c66(bindex, i, j), 'x')
                        end do
                    end do
                ...
                case ('y')
                    ...
                    do jj = 1, m2
                        do ii = 1, m1
                            ...
                            j = (jj - 1)*interval + n2a
                            r(ii, jj) = damp_ratio( &
                                c11(i, bindex, j), c12(i, bindex, j), c13(i, bindex, j), 0.0, 0.0, 0.0, &
                                c22(i, bindex, j), c23(i, bindex, j), 0.0, 0.0, 0.0, &
                                c33(i, bindex, j), 0.0, 0.0, 0.0, &
                                c44(i, bindex, j), 0.0, 0.0, &
                                c55(i, bindex, j), 0.0, &
                                c66(i, bindex, j), 'y')
                        end do
                    end do
                ...
                case ('z')
                    ...
                    do jj = 1, m2
                        do ii = 1, m1
                            ...
                            j = (jj - 1)*interval + n2a
                            r(ii, jj) = damp_ratio( &
                                c11(i, j, bindex), c12(i, j, bindex), c13(i, j, bindex), 0.0, 0.0, 0.0, &
                                c22(i, j, bindex), c23(i, j, bindex), 0.0, 0.0, 0.0, &
                                c33(i, j, bindex), 0.0, 0.0, 0.0, &
                                c44(i, j, bindex), 0.0, 0.0, &
                                c55(i, j, bindex), 0.0, &
                                c66(i, j, bindex), 'z')
                        end do
                    end do
                ...
                do i = nx1, nx2
                    ...
                    if (yn_free_surface) then
                        ...
                        if (k >= nzmax) then
                            ...
                            idaz(i, j, k) = log(1.0/R0)*(npower_d + 1.0)*pmlvp/(2.0*pml*dz_i(k))*nd**npower_d
                            hdaz(i, j, k) = log(1.0/R0)*(npower_d + 1.0)*pmlvp/(2.0*pml*dz_i(k))*ndh**npower_d
